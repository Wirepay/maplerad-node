...
export default class Transactions {
    ...
    public async GetTransaction(transactionId: string):Promise<AxiosResponse | any> {
        try {
    ...
    // The transaction ID or Reference is the parameter for this method
    public async VerifyCollectionTransaction(transactionId: string):Promise<AxiosResponse | any>{
        try{
