...
export default class Bills {
    ...
    public async BuyAirtime(payload: BuyAirtimePayload): Promise<AxiosResponse | any>{
        try{
    ...
    public async GetAirtimeBillers(country: CountryType): Promise<AxiosResponse | any>{
        try{
