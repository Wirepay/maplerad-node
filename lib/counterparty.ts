...
export default class Counterparty {
    ...
    public async Blacklist(counterpartyID:string, status:boolean):Promise<AxiosResponse | any>{
        try{
    ...
    public async GetCounterparty(counterpartyID:string):Promise<AxiosResponse | any>{
        try{
